...
BROT1BTT2a = Class(AHoverLandUnit){
    Weapons = {
        ...
        MainGun = Class(TDFGaussCannonWeapon){
            ...
            PlayFxMuzzleSequence = function(self, muzzle)
                ...
                for k, v in self.FxVentEffect3 do
                    self.unit.Trash:Add(CreateAttachedEmitter(self.unit, 'BROT1BTT2a', army, v):ScaleEmitter(0.7))
                end
    ...
    CreatTheEffectsDeath = function(self)
        ...
        for k, v in TMEffectTemplate['AeonUnitDeathRing01'] do
            self.Trash:Add(CreateAttachedEmitter(self, 'BROT1BTT2a', army, v):ScaleEmitter(0.45))
        end
    end,
}

TypeClass = BROT1BTT2a
