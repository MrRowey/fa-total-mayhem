...
BROT3BT = Class(TLandUnit){
        ...
        MainGun = Class(TDFGaussCannonWeapon){
            ...
            PlayFxMuzzleSequence = function(self, muzzle)
                ...
                for k, v in self.FxGroundEffect do
                    self.unit.Trash:Add(CreateAttachedEmitter(self.unit, 'BROT3BT', army, v):ScaleEmitter(2.55))
                end
                for k, v in self.FxVentEffect3 do
                    self.unit.Trash:Add(CreateAttachedEmitter(self.unit, 'BROT3BT', army, v):ScaleEmitter(2.1))
                end
    ...
    CreatTheEffectsDeath = function(self)
        ...
        for k, v in TMEffectTemplate['AeonUnitDeathRing01'] do
            self.Trash:Add(CreateAttachedEmitter(self, 'BROT3BT', army, v):ScaleEmitter(1.20))
        end
    end,
}
