    ...
    Weapons = {
        gatling1 = Class(TAMPhalanxWeapon){
            PlayFxWeaponPackSequence = function(self)
                ...
                self.ExhaustEffects =
                    EffectUtils.CreateBoneEffects(self.unit, 'Turret_Muzzle_Right02', self.unit:GetArmy(), Effects.WeaponSteam01)
        ...
        gatling2 = Class(TAMPhalanxWeapon){
            PlayFxWeaponPackSequence = function(self)
                ...
                self.ExhaustEffects =
                    EffectUtils.CreateBoneEffects(self.unit, 'Turret_Muzzle_Left02', self.unit:GetArmy(), Effects.WeaponSteam01)
                TAMPhalanxWeapon.PlayFxWeaponPackSequence(self)
            end,
            PlayFxRackSalvoChargeSequence = function(self)
                if not self.SpinManip then
