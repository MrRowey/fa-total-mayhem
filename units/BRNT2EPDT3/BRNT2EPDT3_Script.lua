...
BRNT2EPDT3 = Class(TStructureUnit){
    Weapons = {
        Gauss01 = Class(TDFGaussCannonWeapon){
            ...
            PlayFxMuzzleSequence = function(self, muzzle)
                ...
                for k, v in self.FxGroundEffect do
                    self.unit.Trash:Add(CreateAttachedEmitter(self.unit, 'BRNT2EPDT3', army, v):ScaleEmitter(2.90))
                end
                for k, v in self.FxVentEffect3 do
                    self.unit.Trash:Add(CreateAttachedEmitter(self.unit, 'BRNT2EPDT3', army, v):ScaleEmitter(2.4))
                end
