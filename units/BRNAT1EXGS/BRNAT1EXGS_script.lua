...
BRNAT1EXGS = Class(AAirUnit){
    Weapons = {
        ...
        mediumgauss1 = Class(TDFGaussCannonWeapon){ FxMuzzleFlashScale = 1.0 },
        mediumgauss2 = Class(TDFGaussCannonWeapon){ FxMuzzleFlashScale = 1.0 },
        ...
        rockets = Class(TDFGaussCannonWeapon){ FxMuzzleFlashScale = 0.25 },
    },
