        ...
        MainGun = Class(TDFGaussCannonWeapon){
            ...
            PlayFxMuzzleSequence = function(self, muzzle)
                ...
                for k, v in self.FxGroundEffect do
                    self.unit.Trash:Add(CreateAttachedEmitter(self.unit, 'BRNT2HT', army, v):ScaleEmitter(1.2))
                end
                for k, v in self.FxVentEffect3 do
                    self.unit.Trash:Add(CreateAttachedEmitter(self.unit, 'BRNT2HT', army, v):ScaleEmitter(1.0))
                end
                for k, v in self.FxMuzzleEffect do
                    self.unit.Trash:Add(CreateAttachedEmitter(self.unit, 'Turret_Muzzle', army, v):ScaleEmitter(2.65))
                end
                ...
                for k, v in self.FxVentEffect2 do
                    self.unit.Trash:Add(CreateAttachedEmitter(self.unit, 'Turret_Muzzle', army, v):ScaleEmitter(2.55))
                end
            end,
        },
