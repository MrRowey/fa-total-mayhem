...
BRPT2HVBOT = Class(SWalkingLandUnit){
    Weapons = {
        autoattack = Class(SDFAireauBolterWeapon){ FxMuzzleFlashScale = 0.0 },
        smallgun1 = Class(SDFAireauBolterWeapon){ FxMuzzleFlashScale = 2.4 },
        smallgun2 = Class(SDFAireauBolterWeapon){ FxMuzzleFlashScale = 2.4 },
        smallgun3 = Class(SDFAireauBolterWeapon){ FxMuzzleFlashScale = 2.4 },
        smallgun4 = Class(SDFAireauBolterWeapon){ FxMuzzleFlashScale = 2.4 },
        ChronotronCannon = Class(SDFChronotronCannonWeapon){},
        ChronotronCannon2 = Class(SDFChronotronCannonWeapon){},
        TauCannon01 = Class(SDFThauCannon){ FxMuzzleFlashScale = 0.9 },
        TauCannon02 = Class(SDFThauCannon){ FxMuzzleFlashScale = 0.9 },
    },
