...
BRPT2EXBOT = Class(SWalkingLandUnit){
    Weapons = {
        autoattack = Class(SDFOhCannon){ FxMuzzleFlashScale = 0.0 },
        MainGun = Class(SDFOhCannon){ FxMuzzleFlashScale = 2.0 },
        MainGun2 = Class(SIFSuthanusArtilleryCannon){ FxMuzzleFlashScale = 3.6 },
    },
