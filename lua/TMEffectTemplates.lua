...
BRMT3EXBMPOWEREFFECT = { EmtBpPath .. 'economy_electricity_01_emit.bp' }

BROST2ADVBATTLESHIPTRAILS =
    { EmtBpPathAlt .. 'aeont2battleship_01_emit.bp', EmtBpPathAlt .. 'aeont2battleship_02_emit.bp' }
...
BRMT1EXTANKTRAILS = { EmtBpPathAlt .. 'cybran_advancedt1tank_polytrail_01_emit.bp' }
...
AeonT1FighterPolyTrails = { EmtBpPathAlt .. 'aeonfigther_munition_emit.bp' }
...
YellowLaserPolyTrails = { EmtBpPathAlt .. 'yellowlaser_polytrail_01_emit.bp' }

VultureMolecularPolyTrail = { EmtBpPathAlt .. 'vulture_polytrail_01_emit.bp' }

LightLaserPolyTrail = { EmtBpPathAlt .. 'LightLaserPolyTrail_polytrail_01_emit.bp' }

HeavyLaserPolyTrail = { EmtBpPathAlt .. 'HeavyLaserPolyTrail_polytrail_01_emit.bp' }

UEFArmoredBattleBotTrails =
    { EmtBpPath .. 'seraphim_tau_cannon_projectile_01_emit.bp', EmtBpPath .. 'seraphim_tau_cannon_projectile_02_emit.bp' }
...
AeonNovaCatFireEffect01 =
    { EmtBpPath .. 'disintegratorhvy_hit_sparks_01_emit.bp', EmtBpPath .. 'cybran_corsair_missile_hit_ring.bp' }
...
AeonT3EMPburst = { EmtBpPath .. 'shockwave_01_emit.bp', EmtBpPath .. 'proton_bomb_hit_02_emit.bp' }
